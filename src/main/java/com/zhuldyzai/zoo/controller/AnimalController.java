package com.zhuldyzai.zoo.controller;

import com.zhuldyzai.zoo.entity.Animal;
import com.zhuldyzai.zoo.services.AnimalService;
...
public class AnimalController {
    ...
    @GetMapping("/{id}")
    private ResponseEntity<Animal>
    getAnimalById(@PathVariable("id") String id) {
    ...
    updateAnimal(@PathVariable("id")String id,  @RequestBody Animal animal) {
